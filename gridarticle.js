function gridaddtxt(title, img, prix, lien, tag1, tag2, tag3) {
  ...
  gridarticle += gridaddtxt("Le tshirt tropbien", 'gridarticle.jpg', "30", "article1", "test", "truc muchouette", "blabla");
  gridarticle += gridaddtxt("Le tshirt superbeau", 'gridarticle2.jpg', "2,99", "article1", "pascher", "plastique", "");
  gridarticle += gridaddtxt("Ma chemise d'hier", 'gridarticle3.jpg', "A partir de 399,64", "article1", "sale", "pas repasser", "sent l'ognion");
  gridarticle += gridaddtxt("Le tshirt superbeau", 'gridarticle2.jpg', "2,99", "article1", "pascher", "plastique", "");
  gridarticle += gridaddtxt("Le tshirt superbeau", 'gridarticle2.jpg', "2,99", "article1", "pascher", "plastique", "");
  gridarticle += gridaddtxt("Le tshirt superbeau", 'gridarticle2.jpg', "2,99", "article1", "pascher", "plastique", "");
  gridarticle += gridaddtxt("Le tshirt superbeau", 'gridarticle2.jpg', "2,99", "article1", "pascher", "plastique", "");
