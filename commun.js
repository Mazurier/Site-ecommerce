...
headervar = headervar + header() 

document.getElementById("header").innerHTML=headervar
...
navbarjsvar = navbarjsvar + navbarjs() 

document.getElementById("navbarjs").innerHTML=navbarjsvar
